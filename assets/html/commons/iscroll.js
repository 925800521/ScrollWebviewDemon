!function(window, document, Math) {
        ...
        me.extend(me.ease = {}, {
            ...
            elastic: {
                ...
                fn: function(k) {
                    ...
                    if (0 === k) return 0;
                    if (1 == k) return 1;
                    return e * Math.pow(2, -10 * k) * Math.sin(2 * (k - f / 4) * Math.PI / f) + 1;
                }
            }
        });
    ...
    IScroll.prototype = {
        ...
        _start: function(e) {
            if (1 != utils.eventType[e.type]) if (0 !== e.button) return;
        ...
        _initIndicators: function() {
            var interactive = this.options.interactiveScrollbars, customStyle = "string" != typeof this.options.scrollbars, indicators = [], indicator;
            var that = this;
            this.indicators = [];
    ...
    IScroll.utils = utils;
    if ("undefined" != typeof module && module.exports) module.exports = IScroll; else {
